...
export interface TerminalProps {
  ...
  /** Atraso (ms) entre cada linha de saída. Maior = texto aparece mais devagar. */
        ...
        >
          {lines.map((line, i) => (
            <motion.div
              ...
              initial={line.type === "output" ? { opacity: 0, y: 6 } : false}
              animate={line.type === "output" ? { opacity: 1, y: 0 } : false}
              transition={{
                duration: 0.4,
