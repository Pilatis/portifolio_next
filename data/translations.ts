  ...
  en: {
    ...
    certifications: {
      ...
      items: [
        ...
        { title: "Node.js API Development and Backend Architecture", description: "Training in API development with Node.js, covering RESTful services, database integration, and authentication and authorization in backend applications.", issuer: "Federal Institute of Rio Grande do Sul (IFRS)", skills: ["Node.js", "Express.js", "REST APIs", "Backend Development", "Authentication", "Authorization"], practicalApplication: "Application in building modern APIs with structured routes, database integration and secure access control.", impact: "Improvement in building scalable and secure backend architectures aligned with API development best practices." },
      ],
    },
    experience: {
      heading: "My",
  ...
  pt: {
    ...
    certifications: {
      ...
      items: [
        ...
        { title: "Node.js: desenvolvimento de APIs e arquitetura backend", description: "Formação em desenvolvimento de APIs com Node.js, abordando construção de serviços RESTful, integração com bancos de dados e implementação de autenticação e autorização em aplicações backend.", issuer: "Instituto Federal do Rio Grande do Sul (IFRS)", skills: ["Node.js", "Express.js", "APIs REST", "Desenvolvimento Backend", "Autenticação", "Autorização"], practicalApplication: "Aplicação na construção de APIs modernas, com rotas estruturadas, integração com banco de dados e controle de acesso seguro.", impact: "Aprimoramento na construção de arquiteturas backend escaláveis e seguras, alinhadas com boas práticas de desenvolvimento de APIs." },
      ],
    },
    experience: {
      heading: "Minha",
